...
# -*- coding: utf-8 -*-
"""
This code comes from COMPAS, see https://github.com/TeamCOMPAS/COMPAS
if used, please cite:
Barrett J. W., Gaebel S. M., Neijssel C. J., Vigna-Gómez A., 
Stevenson S., Berry C. P. L., Farr W. M., Mandel I., 2018, MNRAS, 477, 4685
...
def detection_probability(m1, m2, redshift, distance, snr_threshold,sensitivity='design'):
    ...
    path = '/Users/simone/Google Drive/github/POSYDON/posydon/popsyn'

    if sensitivity == 'design':
        hdfDatasetName = 'SimNoisePSDaLIGODesignSensitivityP1200087'
    elif sensitivity == 'O1':
        hdfDatasetName = 'SimNoisePSDaLIGOEarlyHighSensitivityP1200087'
    elif sensitivity == 'O12':
        hdfDatasetName = 'P1500238_GW150914_H1-GDS-CALIB_STRAIN.txt'
    elif sensitivity == 'O2':
        hdfDatasetName = 'SimNoisePSDaLIGOMidHighSensitivityP1200087'
    elif sensitivity == 'O3':
        hdfDatasetName = 'SimNoisePSDaLIGOLateHighSensitivityP1200087'
    elif sensitivity == 'O3low':
        hdfDatasetName = 'SimNoisePSDaLIGOLateLowSensitivityP1200087'
    elif sensitivity == 'ET':
        hdfDatasetName = 'ET_D.txt'
